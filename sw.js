...
registerRoute(({ url }) => url.pathname === "/llaminator/share-target", async ({ request }) => {
  ...
  return Response.redirect("/llaminator/index.html", 302);
}, "POST");
...
registerRoute(({ url }) => true, new StaleWhileRevalidate({
  cacheName
}));
